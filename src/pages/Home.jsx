  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white flex flex-col gap-4">
      ...
      <div className="px-8 flex flex-col gap-4">
        <h1 className="font-climate text-7xl">UI <sub className="text-sm">playground</sub></h1>
      ...
      <footer className="flex justify-between items-center gap-2 p-4 relative">
        <div className="flex place-items-center">
          <Logo />
          <h3 className="font-climate text-6xl flex flex-col gap-2 md:flex-row md:items-end">UI <sub className="text-sm">playground</sub></h3>
        </div>
